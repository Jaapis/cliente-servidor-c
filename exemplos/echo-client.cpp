/*
==================================================================================
Tittle: Program ConsoleApplication19: Echo Client (Non-Blocking)
Date: August/2017
Information: This program is a client that talks to the server program (ConsoleApplication24)
The server App must run first!
